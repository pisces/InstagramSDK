...
Pod::Spec.new do |s|
  s.name             = "InstagramSDK"
  s.version          = "0.1.0"
  s.summary          = "A short description of InstagramSDK."
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/InstagramSDK"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "pisces" => "hh963103@gmail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/InstagramSDK.git", :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'InstagramSDK/Classes/**/*'
  
  # s.resource_bundles = {
  #   'InstagramSDK' => ['InstagramSDK/Assets/*.png']
  # }
